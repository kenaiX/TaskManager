...
public class ScrollPane extends WidgetGroup {
    ...
    public ScrollPane (Actor widget, ScrollPaneStyle style) {
        ...
        flickScrollListener = new ActorGestureListener() {
            ...
            public void pan (InputEvent event, float x, float y, float deltaX, float deltaY) {
                if (!canMove && (forceScrollX || forceScrollY)) {
                    if (forceScrollX) {
    ...
    /** Sets the {@link com.badlogic.gdx.scenes.scene2d.Actor} embedded in this scroll pane.
     ...
     * @see #setWidget(com.badlogic.gdx.scenes.scene2d.Actor) */
     ...
     * based on {@link com.badlogic.gdx.scenes.scene2d.utils.Drawable#getMinWidth()} or {@link com.badlogic.gdx.scenes.scene2d.utils.Drawable#getMinHeight()}. Default is true. */
    public void setVariableSizeKnobs (boolean variableSizeKnobs) {
        this.variableSizeKnobs = variableSizeKnobs;
    }

    /** When true (default), the {@link com.badlogic.gdx.scenes.scene2d.Stage#cancelTouchFocus()} touch focus} is cancelled when flick scrolling begins. This causes
